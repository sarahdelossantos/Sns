s  @extends('sns_final/template_dashboard')
  ...
  <div  class='left' style=' padding-left:5%; padding-right:5%; border-right: 1px;'>
   ...
   <a href=''><div><span class="glyphicon glyphicon-user" style="color:#0066ff;"></span> Friends <span class='pull-right'>{{ $friendCount }}</span></div></a>
    ...
    @endif
      ...
      <div>
        ...
        <?php  $time = \Carbon\Carbon::createFromTimeStamp(strtotime($post->created_at))->diffForHumans() ?>
         ...
         <span><a href='{{url("post/$post->id")}}'style='color:gray;'><span class="glyphicon glyp"hicon-time"></span> {{ $time }}</a></span>
